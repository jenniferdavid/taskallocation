...
static size_t const totalModels(5);  //5+18+5   
    ...
    void fillPathRequest(nav_msgs::GetPlan::Request &request, std::pair<double,double> a, std::pair<double,double> b)
        {
            ...
            srv.request.start.pose.position.x = 12.00;
            srv.request.start.pose.position.y = 26.00;
            srv.request.start.pose.orientation.w = 1.0;

            srv.request.goal.header.frame_id = "map";
            srv.request.goal.pose.position.x = 15;
            srv.request.goal.pose.position.y = 28;
